...
func TestTokens(t *testing.T) {
	var tokenTests = []struct {
		...
		{"/*co\nm\u2028m/*ent*/ //co//mment\u2029//comment", TTs{MultiLineCommentToken, CommentToken, LineTerminatorToken, CommentToken}},
		...
		{"1 /*comment\nmultiline*/ -->nothing\n", TTs{NumericToken, MultiLineCommentToken, CommentToken, LineTerminatorToken}},
