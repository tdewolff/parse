...
func TestTokens(t *testing.T) {
	var tokenTests = []struct {
		...
		{"! ~ && || ? : ??", TTs{NotToken, BitNotToken, AndToken, OrToken, QuestionToken, ColonToken, NullishToken}},
		...
		//{"i(0)/1/g", TTs{IdentifierToken, OpenParenToken, NumericToken, CloseParenToken, DivToken, NumericToken, DivToken, IdentifierToken}},
		//{"if(0)/1/g", TTs{IdentifierToken, PunctuatorToken, NumericToken, PunctuatorToken, RegexpToken}},
		//{"a.if(0)/1/g", TTs{IdentifierToken, DotToken, IfToken, OpenParenToken, NumericToken, CloseParenToken, DivToken, NumericToken, DivToken, IdentifierToken}},
		...
		//{"this/1/g", TTs{ThisToken, DivToken, NumericToken, DivToken, IdentifierToken}},
		...
		//{"this.return/1/g", TTs{ThisToken, DotToken, ReturnToken, DivToken, NumericToken, DivToken, IdentifierToken}},
		//{"(a+b)/1/g", TTs{OpenParenToken, IdentifierToken, AddToken, IdentifierToken, CloseParenToken, DivToken, NumericToken, DivToken, IdentifierToken}},
		...
		//{"x = function() {} /42/i", TTs{IdentifierToken, EqToken, FunctionToken, OpenParenToken, CloseParenToken, OpenBraceToken, CloseBraceToken, DivToken, NumericToken, DivToken, IdentifierToken}},
		//{"x = function foo() {} /42/i", TTs{IdentifierToken, EqToken, FunctionToken, IdentifierToken, OpenParenToken, CloseParenToken, OpenBraceToken, CloseBraceToken, DivToken, NumericToken, DivToken, IdentifierToken}},
		//{"x = /foo/", TTs{IdentifierToken, PunctuatorToken, RegexpToken}},
		//{"x = x / foo /", TTs{IdentifierToken, EqToken, IdentifierToken, DivToken, IdentifierToken, DivToken}},
		...
		//{"x = (a) / foo", TTs{IdentifierToken, EqToken, OpenParenToken, IdentifierToken, CloseParenToken, DivToken, IdentifierToken}},
		//{"bar (true) /foo/", TTs{IdentifierToken, OpenParenToken, TrueToken, CloseParenToken, DivToken, IdentifierToken, DivToken}},
		{"`\\``", TTs{TemplateToken}},
		{"`\\${ 1 }`", TTs{TemplateToken}},
		{"`\\\r\n`", TTs{TemplateToken}},
