...
func TestParse(t *testing.T) {
	var tests = []struct {
		...
		{"var a,\nb = c;", "Stmt(var Binding(a) Binding(b = Expr(c)))"},
		{";", "Stmt(;)"},
		...
		{"for (;;) {}", "Stmt(for ; ; Stmt(;))"},
		{"for (a,b=5;;) {}", "Stmt(for Expr(a , b = Expr(5)) ; ; Stmt(;))"},
		...
		{"function (b) {}", "Stmt(function Params(Binding(b)) Stmt({ }))"},
		{"function a(b) {}", "Stmt(function a Params(Binding(b)) Stmt({ }))"},
		{"async function (b) {}", "Stmt(async function Params(Binding(b)) Stmt({ }))"},
		{"function* (b) {}", "Stmt(function * Params(Binding(b)) Stmt({ }))"},
		{"function (a,) {}", "Stmt(function Params(Binding(a)) Stmt({ }))"},
		{"function (a, b) {}", "Stmt(function Params(Binding(a) Binding(b)) Stmt({ }))"},
		{"function (...a) {}", "Stmt(function Params(... Binding(a)) Stmt({ }))"},
		{"function (a, ...b) {}", "Stmt(function Params(Binding(a) ... Binding(b)) Stmt({ }))"},
		{"class { }", "Stmt(class)"},
		{"class { ; }", "Stmt(class)"},
		...
		{"class { a(b) {} }", "Stmt(class Method(a Params(Binding(b)) Stmt({ })))"},
		{"class { get a() {} }", "Stmt(class Method(get a Params() Stmt({ })))"},
		{"class { set a(b) {} }", "Stmt(class Method(set a Params(Binding(b)) Stmt({ })))"},
		{"class { * a(b) {} }", "Stmt(class Method(* a Params(Binding(b)) Stmt({ })))"},
		{"class { async a(b) {} }", "Stmt(class Method(async a Params(Binding(b)) Stmt({ })))"},
		{"class { async * a(b) {} }", "Stmt(class Method(async * a Params(Binding(b)) Stmt({ })))"},
		{"class { static a(b) {} }", "Stmt(class Method(static a Params(Binding(b)) Stmt({ })))"},
		{"class { [5](b) {} }", "Stmt(class Method([ Expr(5) ] Params(Binding(b)) Stmt({ })))"},
		{"`tmpl`", "Stmt(Expr(`tmpl`))"},
		...
		{"export function(b){}", "Stmt(export Stmt(function Params(Binding(b)) Stmt({ })))"},
		{"export async function(b){}", "Stmt(export Stmt(async function Params(Binding(b)) Stmt({ })))"},
		{"export class{}", "Stmt(export Stmt(class))"},
		{"export default function(b){}", "Stmt(export default Stmt(function Params(Binding(b)) Stmt({ })))"},
		{"export default async function(b){}", "Stmt(export default Stmt(async function Params(Binding(b)) Stmt({ })))"},
		...
		{"async function(){x = await => a++}", "Stmt(async function Params() Stmt({ Stmt(Expr(x = Expr(Params(Binding(await)) => Expr(a ++)))) }))"},
		{"x = {await}", "Stmt(Expr(x = Expr({ await })))"},
		{"x = {async a(b){}}", "Stmt(Expr(x = Expr({ Method(async a Params(Binding(b)) Stmt({ })) })))"},
		{"async function(){ x = {await: 5} }", "Stmt(async function Params() Stmt({ Stmt(Expr(x = Expr({ await : Expr(5) }))) }))"},
		{"async function(){ x = await a }", "Stmt(async function Params() Stmt({ Stmt(Expr(x = Expr(await a))) }))"},
		{"for (var a in b) {}", "Stmt(for Stmt(var Binding(a)) in Expr(b) Stmt(;))"},
		...
		{"x = function() {}", "Stmt(Expr(x = Expr(function Params() Stmt({ }))))"},
		{"x = async function() {}", "Stmt(Expr(x = Expr(async function Params() Stmt({ }))))"},
		{"x = class {}", "Stmt(Expr(x = Expr(class)))"},
		{"x = class {a(){}}", "Stmt(Expr(x = Expr(class Method(a Params() Stmt({ })))))"},
		...
		{"class a extends async function(){}{}", "Stmt(class a extends Expr(async function Params() Stmt({ })))"},
		...
		{"f(); function foo() {} /42/i", "Stmt(Expr(f ( ))) Stmt(function foo Params() Stmt({ })) Stmt(Expr(/42/i))"},
		{"x = function() {} /42/i", "Stmt(Expr(x = Expr(function Params() Stmt({ }) / 42 / i)))"},
		{"x = function foo() {} /42/i", "Stmt(Expr(x = Expr(function foo Params() Stmt({ }) / 42 / i)))"},
